...
public class TestStaff {
	...
	public static void testAddEmployee() {
		...
		String a = e.substring(0, 17); // secem "close" iz stringa
		/*
		...
		driver.findElement(By.className("Box Table-cell Name-cell wide ")) // nalazi celiju zaposlenog*/
		Assert.assertEquals(a, "Boris Nedeljkovic");
	}
